...
use HuntersKingdomBundle\Entity\personne;
...
class personneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personnes = $em->getRepository('HuntersKingdomBundle:personne')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('HuntersKingdomBundle\Form\personneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('HuntersKingdomBundle\Form\personneType', $personne);
